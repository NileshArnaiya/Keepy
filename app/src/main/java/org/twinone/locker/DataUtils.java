...
public class DataUtils {
    ...
    public static final String BACKUP_FOLDER_PATH = "/Keepy-Notes"; // Backup folder path
    public static final String BACKUP_FILE_NAME = "Keepy_backup.json"; // Backup file name
    ...
    public static boolean saveData(File toFile, JSONArray notes) {
        ...
        if (toFile == MainActivity2.getBackupPath()) {
        ...
        else if (toFile == MainActivity2.getLocalPath() && !toFile.exists()) {
            try {
                Boolean created = toFile.createNewFile();
    ...
    public static JSONArray retrieveData(File fromFile) {
        ...
        if (fromFile == MainActivity2.getBackupPath()) {
         ...
         */
        else if (fromFile == MainActivity2.getLocalPath() && !fromFile.exists()) {
            notes = new JSONArray();
